  ...
  return (
    <div>
      ...
      <section className="mx-auto max-w-6xl px-4 py-16">
        <h2 className="mb-2 text-center text-2xl font-bold sm:text-3xl">¿Qué vas a encontrar?</h2>
      ...
      <section className="border-y border-surface-800 bg-surface-900/30">
        <div className="mx-auto max-w-6xl px-4 py-16">
          <h2 className="mb-10 text-center text-2xl font-bold sm:text-3xl">Simple de verdad</h2>
